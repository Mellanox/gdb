...
struct target_desc *tdesc_compatible_arcompact;
static void
initialize_tdesc_compatible_arcompact (void)
{
  ...
  tdesc_create_reg (feature, "ilink1", 29, 1, "general", 32, "code_ptr");
  tdesc_create_reg (feature, "ilink2", 30, 1, "general", 32, "code_ptr");
  ...
  tdesc_create_reg (feature, "r58", 58, 1, "", 32, "int");
  tdesc_create_reg (feature, "r59", 59, 1, "", 32, "int");
